...
const agreementStages = ["Buyer Offer", "Counteroffer", "Buyer Decision", "Agreement", "Locked Terms", "CAP Settlement", "Completed"] as const;
const noDealStages = ["Buyer Offer", "Counteroffer", "Buyer Decision", "No Deal"] as const;
...
function narrativeStageFlags(revealed: Step[], buyerAgentId: string, isNoDeal: boolean): Record<string, boolean> {
  ...
  if (isNoDeal) {
    return {
      "Buyer Offer": hasOpeningOffer,
      Counteroffer: hasCounter,
      "Buyer Decision": hasBuyerCounter,
      "No Deal": hasNoDeal,
    };
  }
...
function NarrativeStepper({ revealed, buyerAgentId, isNoDeal }: { revealed: Step[]; buyerAgentId: string; isNoDeal: boolean }) {
  ...
  return (
    <>
      ...
      <p className="theaterCaption">
        Every counteroffer is generated by checking the seller&apos;s price floor, rush fee, and discount rules —
